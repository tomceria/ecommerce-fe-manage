      ...
      <LayoutCardStyled>
        ...
        <div>
          <Link to="/products/scales/add" style={{ flexGrow: 1 }}>
            <Button color="primary">{t("UI.PAGES.PRODUCTS.SCALES.ADD")}</Button>
          </Link>
        </div>
      </LayoutCardStyled>
      <LayoutCard>
        <h2 className="title">{t("UI.PAGES.PRODUCTS.SCALES.HOME")}</h2>
        <ViewScalesCtn
          tableHead={[
            ...
            { id: "placing", label: t("SCALES.LABEL.PLACING"), width: 192, noSort: true }
          ]}
        />
      </LayoutCard>
    </>
