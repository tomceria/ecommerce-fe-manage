      ...
      <LayoutCardStyled>
        ...
        <div>
          <Link to="/products/makers/add" style={{ flexGrow: 1 }}>
            <Button color="primary">{t("UI.PAGES.PRODUCTS.MAKERS.ADD")}</Button>
          </Link>
        </div>
      </LayoutCardStyled>
      <LayoutCard>
        <h2 className="title">{t("UI.PAGES.PRODUCTS.MAKERS.HOME")}</h2>
        <ViewMakersCtn
          tableHead={[
            ...
            { id: "placing", label: t("MAKERS.LABEL.PLACING"), width: 192, noSort: true }
          ]}
        />
      </LayoutCard>
    </>
